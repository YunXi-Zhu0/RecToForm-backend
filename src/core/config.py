...
OUTPUT_CLEANUP_TIMEZONE = os.getenv("OUTPUT_CLEANUP_TIMEZONE", "Asia/Shanghai")
OUTPUT_CLEANUP_HOUR = _get_int_env("OUTPUT_CLEANUP_HOUR", 4)
OUTPUT_CLEANUP_MINUTE = _get_int_env("OUTPUT_CLEANUP_MINUTE", 0)
